...
double qagi(Integrand f, double bound, int inf, double epsabs, double epsrel, double *abserr, int *neval, int *ier) {
    ...
    double alist[kLIMIT], blist[kLIMIT], elist[kLIMIT], rlist[kLIMIT];
    double rlist2[52], small = 0; /* small will be initialized in _80 */

    int id, ierro, iord[kLIMIT], iroff1, iroff2, iroff3, jupbnd, k, ksgn;
